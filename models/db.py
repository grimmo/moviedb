...
db.film.titolo.represent = lambda value,row:     A(value, _href=URL('film', args=db.film(db.film.titolo==value).id))
...
db.moviecast.nome.represent = lambda value,row:     A(value, _href=URL('persona', args=db.moviecast(db.moviecast.nome==value).tmdb_id))
